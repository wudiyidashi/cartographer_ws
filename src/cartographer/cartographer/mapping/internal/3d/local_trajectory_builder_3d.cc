...
LocalTrajectoryBuilder3D::AddRangeData(
  ...
  // Step: 3 Ԥ��� ÿ�����ʱ���ʱ��, tracking frame �� local slam ����ϵ�µ�λ��
  ...
  return AddAccumulatedRangeData(
      current_time,
      // Step: 6 ��ԭ��λ�ڻ����˵�ǰλ�˴��ĵ��� ת�� ԭ��λ��local����ϵԭ�㴦�ĵ���
 ...
 * 
 * @param[in] time ���Ƶ�ʱ��
 * @param[in] filtered_range_data_in_tracking ԭ��λ��local����ϵԭ�㴦�ĵ���
 * @param[in] sensor_duration 2֡�������ݵ�ʱ���
 * @param[in] pose_prediction Ԥ����ĵ�ǰλ��
...
LocalTrajectoryBuilder3D::AddAccumulatedRangeData(
  ...
  // Step: 9 �� ԭ��λ��local����ϵԭ�㴦�ĵ��� �任�� ԭ��λ��ƥ����λ�˴��ĵ���
