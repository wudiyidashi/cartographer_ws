...
def generate_launch_description():
    ...
    slam_configuration_basenames_arg = DeclareLaunchArgument('slam_configuration_basenames_arg', default_value = 'lx_rs16_2d_outdoor.lua')
    ...
    arguments = [
        ...
        '-configuration_basename', LaunchConfiguration('slam_configuration_basenames_arg'),
        '-load_state_filename', LaunchConfiguration('load_state_filename'),
        '-configuration_localization_basename',LaunchConfiguration('configuration_basenames'),
        ],
    remappings = [
    ...
    return LaunchDescription([
        ...
        slam_configuration_basenames_arg,
        # Nodes
