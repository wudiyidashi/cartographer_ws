...
#include "cartographer_ros_msgs/srv/relocate.hpp"
...
class Node {
 public:
  ...
  void StartTrajectoryWithDefaultTopics(const TrajectoryOptions& options);
    ...
    bool relocate(cartographer::transform::Rigid2d* best_pose_estimate, float* best_score);
...
bool handleRelocate(const std::shared_ptr<cartographer_ros_msgs::srv::Relocate::Request> request,
...
//   ::rclcpp::Service<cartographer_ros_msgs::srv::ReadMetrics>::SharedPtr read_metrics_server_;
  ::rclcpp::Service<cartographer_ros_msgs::srv::Relocate>::SharedPtr relocate_server_;
  ...
  //获取2D点云
  ::rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr point_cloud_map_publisher_;
  absl::Mutex point_cloud_map_mutex_;
  bool load_state_ = false;
  size_t last_trajectory_nodes_size_ = 0;
  sensor_msgs::msg::PointCloud2 ros_point_cloud_map_;
